...
// test to verify that if the summary generation fails, it does not break the assistant's ability to reply to messages
test("summary fail does not break replies", async () => {
  ...
  process.env.TEST_SUMMARY_FAIL = "true";
